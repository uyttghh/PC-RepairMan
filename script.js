...
const botResponses = {
    ...
    'какие гарантии': 'Мы предоставляем гарантию 14 дней на все сборки! Также действует гарантия от производителей комплектующих. 🛡️',
    'сроки сборки': 'Обычно сборка занимает от 3 до 7 дней в зависимости от сложности и наличия комплектующих. ⏱️',
    'связаться с менеджером': 'Конечно! Вы можете позвонить нам: +7 (950) 460-52-65 или написать в Telegram: @pcrepairmann 👨‍💼',
    'адрес': 'Наш адрес: г. Пермь, п. Сылва, ул. Корнеева, д. 25 📍',
    'работаете': 'Да, мы работаем ежедневно с 10:00 до 20:00! 🕐',
    'рассрочка': 'Нет, к сожаению, мы не предлогаем рассрочку. 💳',
